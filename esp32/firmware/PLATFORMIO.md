...
| File / folder | Purpose |
|---------------|---------|
| `platformio.ini` | Board + ESP-IDF framework |
...
If you get **Unknown board `esp32-s3-devkitc-1-n16r8`**, use the fallback env:

```bash
pio run -e esp32-s3-devkitc-1
```

Then use that same env name for upload below.
